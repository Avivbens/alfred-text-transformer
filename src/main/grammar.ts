...
import { GRAMMAR_SYSTEM_PROMPT } from '@common/ai-prompts.constant'
...
;(async () => {
    ...
    try {
        ...
        const res = await callModel(token, model, { system: GRAMMAR_SYSTEM_PROMPT, user: alfredClient.input })
